...
if(ADD_INGRED_BTN.hasAttribute("onclick")) {
	console.log(true);
} else {
	console.log("Attr not found");
	ADD_INGRED_BTN.setAttribute("onclick", "add_ingred_form()");
}

// if(INGRED_CONTAINER.hasAttributes()) {
	// console.log(INGRED_CONTAINER.attributes);
// } else {
	// console.log("Need to add attributes");
// }

console.log(ADD_INGRED_BTN.attributes);

function add_ingred_form(ingredients, amts) {
